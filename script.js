...
function creating_long_lat(locationName, type) {
  // Using the location from the fucking form to create a long and lat value using nominatim which is a part of openstreetmap.
  fetch(
    ...
    .then((data) => {
      if (data.length > 0) {
        ...
        alert(
          "Mc Dont know the correct spelling madharchod. Correct it and try again asshole."
        );
      }
    })
    .catch((error) => {
